...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "pi05_modified":
        return PI05ModifiedConfig(**kwargs)
    elif policy_type == "sac":
        return SACConfig(**kwargs)
    elif policy_type == "smolvla":
        return SmolVLAConfig(**kwargs)
    elif policy_type == "smolvla_modified":
        return SmolVLAModifiedConfig(**kwargs)
    ...
    elif policy_type == "xvla_modified":
        return XVLAModifiedConfig(**kwargs)
